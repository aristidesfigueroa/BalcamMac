...
public class BalcamToken {
    ...
    public static void Post_JSON() throws MalformedURLException, IOException, SQLException, ParseException {
        ...
        try {
            ...
            Logger.getLogger(BalcamToken.class.getName()).log(Level.SEVERE, null, ex);
        }
        try {
...
//            String query_url = "https://wsbalcampruebas.bch.sf/api/Login/Autenticacion";
...
//            conn.setRequestProperty("ApiKey", "KeytoPass");
...
//            String result0 = IOUtils.toString(is, "UTF-8");
